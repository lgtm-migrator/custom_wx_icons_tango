...
.. code-block:: bash
    ...
    $ git clone https://github.com/domdfcoding/custom_wx_icons_tango"
    > Cloning into 'custom_wx_icons_tango'...
...
The recommended way to build ``wx_icons_tango`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
